  ...
  return (
    <div className="w-full">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-0 mb-6 lg:mb-8">
        <p className="text-xl lg:text-[28px] font-bold text-[#212121] dark:text-white">Recent Uploads</p>
     ...
     <Link href="/uploads" className="bg-[#fcfdfd] dark:bg-[#1a1d24] border border-[#e5e5e5] dark:border-[#2a2e37] text-[#212121] dark:text-white text-xs lg:text-base flex items-center gap-1.5 lg:gap-2 px-3 lg:px-4 py-2 lg:py-3.5 rounded-lg">
     ...
     <div className="flex items-center bg-[#fcfdfd] dark:bg-[#15171d] border-b border-[#f2f4f7] dark:border-[#2a2e37] min-w-[500px] lg:min-w-0">
      {columns.map((col) => (
      <p
        key={col}
        className="flex-1 font-bold text-sm lg:text-lg text-[#212121] dark:text-white tracking-tight px-3 lg:px-6 py-3 lg:py-6 first:pl-4 lg:first:pl-8 whitespace-nowrap"
      >
              {col}
            </p>
          ))}
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center gap-4 lg:gap-6 py-12 lg:py-20 px-4">
            ...
            <div className="flex flex-col items-center gap-2 max-w-[300px] lg:max-w-[400px] text-center">
              <p className="text-lg lg:text-[22px] text-[#212121] dark:text-white">No uploads yet</p>
              ...
              return (
                <div key={upload.id} className="flex items-center border-b border-[#f2f4f7] dark:border-[#2a2e37] last:border-b-0">
                  <div className="flex-1 flex items-center gap-3 lg:gap-4 px-4 lg:px-8 py-4 lg:py-8">
                    ...
                    />
                    <div>
                     <p className="text-sm lg:text-base text-[#212121] dark:text-white">{upload.title}</p>
                      <p className="text-xs text-[#909dad]">{upload.size}</p>
                    </div>
                  </div>
                  <p className="flex-1 text-sm lg:text-base text-[#101828] dark:text-[#d5d8dd] px-3 lg:px-6">{upload.course}</p>
                  ...
                  <p className="flex-1 text-sm lg:text-base text-[#101828] dark:text-[#d5d8dd] px-3 lg:px-6">{upload.points}</p>
                </div>
              );
            })}
          </div>
